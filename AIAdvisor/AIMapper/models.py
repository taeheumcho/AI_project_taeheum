...
class EtfCategory(models.Model):
    ...
    code = models.CharField(db_column='CODE', unique=True, max_length=45, blank=True)  # Field name made lowercase.
...
class EtfInfo(models.Model):
    idx = models.IntegerField(db_column='IDX', primary_key=True)  # Field name made lowercase.
    ticker = models.CharField(db_column='TICKER', unique=True, max_length=45, blank=True)  # Field name made lowercase.
    name = models.CharField(db_column='NAME', max_length=255, blank=True)  # Field name made lowercase.
    category_code = models.CharField(db_column='CATEGORY_CODE', max_length=10, blank=True)  # Field name made lowercase.
    fund_family = models.CharField(db_column='FUND_FAMILY', max_length=90, blank=True)  # Field name made lowercase.
    exchange = models.CharField(db_column='EXCHANGE', max_length=10, blank=True)  # Field name made lowercase.
    country = models.CharField(db_column='COUNTRY', max_length=10, blank=True)  # Field name made lowercase.
    ccy_cd = models.CharField(db_column='CCY_CD', max_length=10, blank=True)  # Field name made lowercase.
    crtn_time = models.DateTimeField(db_column='CRTN_TIME', blank=True, null=True)  # Field name made lowercase.
    update_time = models.DateTimeField(db_column='UPDATE_TIME', blank=True, null=True)  # Field name made lowercase.
...
class FuturesData(models.Model):
    idx = models.IntegerField(db_column='IDX', primary_key=True)  # Field name made lowercase.
    dt = models.CharField(db_column='DT', max_length=8, blank=True)  # Field name made lowercase.
    ticker = models.CharField(db_column='TICKER', max_length=45, blank=True)  # Field name made lowercase.
    overnight_cd = models.CharField(db_column='OVERNIGHT_CD', max_length=2, blank=True)  # Field name made lowercase.
...
class FuturesInfo(models.Model):
    ...
    ticker = models.CharField(db_column='TICKER', unique=True, max_length=45, blank=True)  # Field name made lowercase.
    name = models.CharField(db_column='NAME', max_length=255, blank=True)  # Field name made lowercase.
    short_ticker = models.CharField(db_column='SHORT_TICKER', max_length=45, blank=True)  # Field name made lowercase.
    expire_dt = models.CharField(db_column='EXPIRE_DT', max_length=6, blank=True)  # Field name made lowercase.
    spread_type = models.CharField(db_column='SPREAD_TYPE', max_length=2, blank=True)  # Field name made lowercase.
    type_cd = models.CharField(db_column='TYPE_CD', max_length=45, blank=True)  # Field name made lowercase.
    crtn_time = models.DateTimeField(db_column='CRTN_TIME', blank=True, null=True)  # Field name made lowercase.
    update_time = models.DateTimeField(db_column='UPDATE_TIME', blank=True, null=True)  # Field name made lowercase.
...
class FuturesInvestor(models.Model):
    ...
    ticker = models.CharField(db_column='TICKER', max_length=45, blank=True)  # Field name made lowercase.
    overnight_cd = models.CharField(db_column='OVERNIGHT_CD', max_length=2, blank=True)  # Field name made lowercase.
    investor_cd = models.CharField(db_column='INVESTOR_CD', max_length=4, blank=True)  # Field name made lowercase.
...
class FxInfo(models.Model):
    ...
    ticker = models.CharField(db_column='TICKER', unique=True, max_length=45, blank=True)  # Field name made lowercase.
    name = models.CharField(db_column='NAME', max_length=255, blank=True)  # Field name made lowercase.
    ccy1 = models.CharField(db_column='CCY1', max_length=10, blank=True)  # Field name made lowercase.
    ccy2 = models.CharField(db_column='CCY2', max_length=10, blank=True)  # Field name made lowercase.
    crtn_time = models.DateTimeField(db_column='CRTN_TIME', blank=True, null=True)  # Field name made lowercase.
    update_time = models.DateTimeField(db_column='UPDATE_TIME', blank=True, null=True)  # Field name made lowercase.
...
class IrInfo(models.Model):
    idx = models.IntegerField(db_column='IDX', primary_key=True)  # Field name made lowercase.
    ticker = models.CharField(db_column='TICKER', unique=True, max_length=45, blank=True)  # Field name made lowercase.
    irc_cd = models.CharField(db_column='IRC_CD', max_length=45, blank=True)  # Field name made lowercase.
    mrty_cd = models.CharField(db_column='MRTY_CD', max_length=10, blank=True)  # Field name made lowercase.
    name = models.CharField(db_column='NAME', max_length=255, blank=True)  # Field name made lowercase.
    crtn_time = models.DateTimeField(db_column='CRTN_TIME', blank=True, null=True)  # Field name made lowercase.
    update_time = models.DateTimeField(db_column='UPDATE_TIME', blank=True, null=True)  # Field name made lowercase.
...
class StockInfo(models.Model):
    ...
    country = models.CharField(db_column='COUNTRY', max_length=10, blank=True)  # Field name made lowercase.
    ccy_cd = models.CharField(db_column='CCY_CD', max_length=10, blank=True)  # Field name made lowercase.
    data_source = models.CharField(db_column='DATA_SOURCE', max_length=5, blank=True)  # Field name made lowercase.
    crtn_time = models.DateTimeField(db_column='CRTN_TIME', blank=True, null=True)  # Field name made lowercase.
    update_time = models.DateTimeField(db_column='UPDATE_TIME', blank=True, null=True)  # Field name made lowercase.
...
class StockSuspension(models.Model):
    ...
    dt = models.CharField(db_column='DT', max_length=8, blank=True)  # Field name made lowercase.
    ticker = models.CharField(db_column='TICKER', max_length=45, blank=True)  # Field name made lowercase.
    start_dt = models.CharField(db_column='START_DT', max_length=8, blank=True)  # Field name made lowercase.
    reason = models.CharField(db_column='REASON', max_length=255, blank=True)  # Field name made lowercase.
    crtn_time = models.DateTimeField(db_column='CRTN_TIME', blank=True, null=True)  # Field name made lowercase.
    update_time = models.DateTimeField(db_column='UPDATE_TIME', blank=True, null=True)  # Field name made lowercase.
...
class XpathData(models.Model):
    idx = models.IntegerField(db_column='IDX', primary_key=True)  # Field name made lowercase.
    code = models.CharField(db_column='CODE', unique=True, max_length=45, blank=True)  # Field name made lowercase.
    xpath_code = models.CharField(db_column='XPATH_CODE', max_length=45, blank=True)  # Field name made lowercase.
    xpath = models.CharField(db_column='XPATH', max_length=255, blank=True)  # Field name made lowercase.
    xpath_index = models.IntegerField(db_column='XPATH_INDEX', blank=True, null=True)  # Field name made lowercase.
    use = models.CharField(db_column='USE', max_length=1, blank=True)  # Field name made lowercase.
    insert_column = models.CharField(db_column='INSERT_COLUMN', max_length=45, blank=True)  # Field name made lowercase.
...
class XpathInfo(models.Model):
    idx = models.IntegerField(db_column='IDX', primary_key=True)  # Field name made lowercase.
    code = models.CharField(db_column='CODE', unique=True, max_length=45, blank=True)  # Field name made lowercase.
    sitecode = models.CharField(db_column='SITECODE', max_length=10, blank=True)  # Field name made lowercase.
    url = models.CharField(db_column='URL', max_length=255, blank=True)  # Field name made lowercase.
    description = models.CharField(db_column='DESCRIPTION', max_length=255, blank=True)  # Field name made lowercase.
